...
*does* internally), see **[Simulator](/en/simulator/architecture)**.
...
| Flag | Type | Default | Description |
| --- | --- | --- | --- |
| `--dataset` | path | `None` | JSONL workload file. See **[Workloads → JSONL format](/en/workloads/jsonl-format)** |
...
**[Simulator](/en/simulator/architecture)** section. For runnable
examples, see **[Examples](/en/examples)**.
