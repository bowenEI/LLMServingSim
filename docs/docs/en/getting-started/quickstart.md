...
**[Reading the output](/en/simulator/reading-output)**.
...
[Reference → CLI flags](/en/reference/cli-flags).
...
- **[Simulator → Architecture overview](/en/simulator/architecture)**
  to understand how the simulator runs internally.
- **[Simulator → Reading the output](/en/simulator/reading-output)**
  to understand the metrics in `*.csv`.
- **[Workloads → JSONL format](/en/workloads/jsonl-format)**
  to drive the simulator with your own traces.
- **[Profiler overview](/en/profiler/overview)** if you want to
