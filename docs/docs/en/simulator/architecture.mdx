...
> "how to configure it," see **[Examples](/en/examples)** instead.
...
| `config_builder.py` | Cluster config → ASTRA-Sim input files | [Examples → Cluster config explained](/en/examples/cluster-config-explained) |
