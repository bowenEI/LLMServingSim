...
**[Simulator → Request lifecycle](/en/simulator/request-lifecycle#agentic-sessions-when-stage-10-is-not-the-end)**.
...
- **[Simulator → Request lifecycle](/en/simulator/request-lifecycle)**
  what happens at runtime when the simulator processes a session.
- **[Examples → DP+EP MoE](/en/examples/parallelism/dp-ep-moe)** -
